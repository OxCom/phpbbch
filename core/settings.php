...
class settings
{
    ...
    public static function getThemes()
    {
        $list = [
            ...
            'base16/harmonic-16-dark'              => 'Base16 / Harmonic 16Dark',
            'base16/harmonic-16-light'             => 'Base16 / Harmonic 16Light',
            ...
            'base16u/silk-dark'                    => 'Base16 / SilkDark',
            'base16/silk-light'                    => 'Base16 / SilkLight',
